...
const ReadBookPages = () => {
  ...
  return (
    <div className='container mx-auto my-7 flex justify-center items-center'>
    ...
    >
     ...
     <p className='text-center text-3xl font-bold'>No Reads Books To Display</p> 
    }
    </div>
  );
};

export default ReadBookPages;